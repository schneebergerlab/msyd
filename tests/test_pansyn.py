    ...
    return (Pansyn(Range('test', 1, 'NaN', 101, 200),
        {
            ...
            'test1': Cigar.from_string('30=1X29=1X9=10D10=10I10='),
...
def test_basic(overlapping_pansyns, cg, detect_crosssyn, allow_overlap):
    """
...
def test_nocg(overlapping_pansyns):
    """
    ...
    res = calc_overlap(l, r)#, detect_crosssyn=detect_crosssyn, allow_overlap=allow_overlap)
    ov = res[0]
    assert ov == Pansyn(Range('test', 1, 'NaN', 151, 200),
            {
