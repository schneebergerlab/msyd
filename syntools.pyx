...
def calc_overlap(l: Pansyn, r: Pansyn, detect_crosssyn=True, allow_overlap=False):
    """
    ...
    # core synteny
    ret.append(l.drop(ovstart - l.ref.start, l.ref.end - ovend) + r.drop(ovstart - r.ref.start, r.ref.end - ovend))
