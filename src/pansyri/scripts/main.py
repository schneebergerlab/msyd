...
def main(argv):
    ...
    inputmode.add_argument("--combinations", "--comb", "--combs", dest='call', action='store_const', const=combinations, help="Evaluate all combinations of --syn and --core. If --core is not specified, print out a table containing the total length of multisyntenic regions by degree.")
    ...
    inputmode.add_argument("--print", "-p", dest='call', action='store_const', const=dfprint, help="Print the full DataFrame containing all called multisyntenic regions")
    inputmode.add_argument("--shortprint", "--sp", dest='call', action='store_const', const=shortprint, help="Print a part of the DataFrame containing the called multisyntenic regions.")
